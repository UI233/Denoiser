...
void Noise::initParameters()
{
    ...
    parameter_set_->addParameter(string("Noise level"), 0.5);
    parameter_set_->addParameter(string("Impulsive level"), 0.5);
    parameter_set_->addParameter(string("Noise type"), 0);


    parameter_set_->addParameter(string("Noise direction"), 1);
}
